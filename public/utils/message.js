...
Message.prototype.msg = function (options) {
  ...
  box.style.cssText = 'max-width:400px;background-color: #fff;border-radius: 4px;font-size: 14px; padding: 6px 20px;overflow: hidden;position: fixed;z-index: 1001;top: 10%;margin-top:-100px;left:50%;box-shadow: 0 0 5px rgba(0,0,0,0.5);visibility: hidden;'
